...
import 'package:auradocs_android/screens/Document-Search/view_searched_doc.dart';
...
class AdvancedSearchedListScreen extends StatefulWidget {
  ...
  @override
  State<AdvancedSearchedListScreen> createState() =>
      _AdvancedSearchedListScreenState();
}

class _AdvancedSearchedListScreenState
    extends State<AdvancedSearchedListScreen> {
  ...
  Future<void> getSharedPrefrences() async {
    ...
    if (widget.searchValue.isNotEmpty) {
      context.read<DocumentBloc>().add(
            FetchAdvancedeSearchDocuments(widget.searchValue,
                widget.templateName, widget.templateId, widget.fieldId, token),
          );
    }
  }
                    ...
                    Column(
                      children: [
                        ...
                        BlocBuilder<DocumentBloc, DocumentState>(
                          ...
                          } else if (state is AdvancedSearchedListLoaded) {
                            final List<dynamic> docs = state.documents ?? [];
                                                  ...
                                                  if (state.totalPages! > 5) {
                                                    int pageIndexToScrollTo =
                                                        ((startIndex ~/ 4) -
                                                            ...
                                                            40;
                                                    print(
                                                        "pageIndexToScrollTo $pageIndexToScrollTo");
