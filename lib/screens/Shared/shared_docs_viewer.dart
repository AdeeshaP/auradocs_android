...
class SharedDocsViewerScreen extends StatefulWidget {
  const SharedDocsViewerScreen({
    super.key,
  ...
  @override
  State<SharedDocsViewerScreen> createState() => _SharedDocsViewerScreenState();
}

class _SharedDocsViewerScreenState extends State<SharedDocsViewerScreen> {
  double _scale = 1.0;
